...
| VS-REC-005 | Создать GitHub repository после чистой установки и проверки `.gitignore`/секретов | blocked | `vital_shevron_bootstrap_plan.md` | Локальный git создан, commit `b79434a`; для GitHub remote нужно согласовать account/org, имя, visibility и способ доступа (`gh` CLI на сервере не найден) |
