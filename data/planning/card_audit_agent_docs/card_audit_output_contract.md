...
- Ozon: название, габариты/вес упаковки, бренд, модель, ТН ВЭД, хештеги,
  ...
  заводских упаковок;
- WB: наименование, категория, 18+, vendorCode/nmID/barcode как неизменяемые,
  бренд, цвет, ТНВЭД, КИЗ, описание, габариты/вес, вид декора, состав,
  страна, количество предметов, комплектация, НДС как unchanged/review.
...
абзаца/блока. Размеры упаковки, marketplace-specific размеры упаковки и вес не
вставлять в продающее описание; показывать их в параметрах карточки, паспорте
товара и таблице `сейчас -> рекомендую -> почему`.
...
назначение и короткий блок о производителе.
