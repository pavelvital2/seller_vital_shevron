...
PYTHONPATH=src /home/Codex/agent-tools/python/bin/python -m takterra_agent.cli bot poll-loop --live-today --live-status --allowed-chat-id 123456789 --max-iterations 1 --token-file /home/pavel/.secrets/vital_shevron_telegram_bot_token
```
